...
import (
	...
	apierror "github.com/alisongabiatti/Twonkies/src/internals/api_errors"
	"github.com/alisongabiatti/Twonkies/src/internals/log"
...
var (
	Redis = NewRedis(Config{Host: "localhost", Port: 6379})
)
...
func (r RedisCache) HSet(ctx context.Context, key, field, value string) error {
	...
	logAction := fmt.Sprintf("set key %s ", key)
...
// func Ping(ctx context.Context, c *redis.Client) {
